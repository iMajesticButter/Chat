...
void ProcessIncomingMSG(SOCKET, fd_set&, SOCKET, std::string, RoomList&, Namelist*, fd_set&);
...
chatcmd::ParsedMSG ParseAndCommands(SOCKET, SOCKET, fd_set&, char[], RoomList&, std::string, Namelist*, fd_set&);
